USE [master]
GO
/****** Object:  Database [MedicCare]    Script Date: 6.09.2025 00:22:32 ******/
...
USE [MedicCare]
GO
/****** Object:  Table [dbo].[__EFMigrationsHistory]    Script Date: 6.09.2025 00:22:33 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Abouts]    Script Date: 6.09.2025 00:22:33 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Contacts]    Script Date: 6.09.2025 00:22:33 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[Contacts](
	...
	[SocialOne] [nvarchar](max) NOT NULL,
	[SocialTwo] [nvarchar](max) NOT NULL,
	[SocialThree] [nvarchar](max) NOT NULL,
...
GO
/****** Object:  Table [dbo].[Experiences]    Script Date: 6.09.2025 00:22:33 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Profiles]    Script Date: 6.09.2025 00:22:33 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Testimonials]    Script Date: 6.09.2025 00:22:33 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
INSERT [dbo].[__EFMigrationsHistory] ([MigrationId], [ProductVersion]) VALUES (N'20250901100034_CreateContacttt', N'8.0.19')
GO
SET IDENTITY_INSERT [dbo].[Abouts] ON 

INSERT [dbo].[Abouts] ([Id], [Title], [Text], [Years], [İmage1], [İmage2]) VALUES (1, N'Protect yourself and others by wearing masks and washing hands frequently. Outdoor is safer than indoor for gatherings or holding events. People who get sick with Coronavirus disease (COVID-19) will experience mild to moderate symptoms and recover without special treatments.', N'You can feel free to use this CSS template for your medical profession or health care related websites. You can support us a little via PayPal if this template is good and useful for your work.', N'12', N' medium-shot-man-getting-vaccine.jpg', N'female-doctor-with-presenting-hand-gesture.jpg')
INSERT [dbo].[Abouts] ([Id], [Title], [Text], [Years], [İmage1], [İmage2]) VALUES (7, N'ASDD', N'strADSDASDASing', N'strFFFSDFSDFing', N'stFDSFDSFDSFSDFring', N'stFDSFDSFDSFDSring')
INSERT [dbo].[Abouts] ([Id], [Title], [Text], [Years], [İmage1], [İmage2]) VALUES (8, N'dd', N'ddd', N'ddd', N'dddd', N'dddd')
SET IDENTITY_INSERT [dbo].[Abouts] OFF
GO
SET IDENTITY_INSERT [dbo].[Contacts] ON 

INSERT [dbo].[Contacts] ([Id], [Email], [Address], [SocialOne], [SocialTwo], [SocialThree]) VALUES (1, N'eymenyaman@gmail.com', N'merkez efendi nono3', N'https://www.facebook.com', N'https://www.twitter.com', N'https://www.instagram.com')
...
INSERT [dbo].[Experiences] ([Id], [Title], [Text], [Icon], [DateTime]) VALUES (4, N'Covid-19 Hospitals', N'Fusce vestibulum euismod nulla sed ultrices. Praesent rutrum nulla vel sapien euismod, quis tempus dui placerat.Integer posuere erat a ante venenatis dapibus posuere velit aliquet. Maecenas faucibus mollis interdum. Donec ullamcorper nulla non metus auctor fringilla', N'bi-globe timeline-icon', CAST(N'2020-05-24T14:35:50.0000000' AS DateTime2))
...
INSERT [dbo].[Profiles] ([Id], [Name], [Title], [Text], [Phone]) VALUES (5, N'Eymen', N'Days', N'Çok Başarılı Bir Yazılımcıdır', N'05364414545')
SET IDENTITY_INSERT [dbo].[Profiles] OFF
GO
SET IDENTITY_INSERT [dbo].[Testimonials] ON 

INSERT [dbo].[Testimonials] ([Id], [Rating], [Title], [Text], [Image], [Name], [Surname]) VALUES (1, 1, N'SARIŞIN', N'Phasellus ligula ante, tempus ac imperdiet ut, mattis ac nibh. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.', N'beautiful-woman-face-portrait-brown-background.jpeg', N'Marie', N'Patient')
INSERT [dbo].[Testimonials] ([Id], [Rating], [Title], [Text], [Image], [Name], [Surname]) VALUES (2, 2, N'ESMER', N'Donec in elementum orci, nec posuere ligula. Quisque vulputate diam et ullamcorper ullamcorper. Pellentesque vestibulum neque at leo fermentum mattis.', N'senior-man-wearing-white-face-mask-covid-19-campaign-with-design-space.jpeg', N'Ben Walker', N'Recovered')
INSERT [dbo].[Testimonials] ([Id], [Rating], [Title], [Text], [Image], [Name], [Surname]) VALUES (3, 4, N'Great services!', N'Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Donec sit amet velit vitae purus aliquam efficitur.', N'portrait-british-woman.jpeg', N'Laura Zono', N' New Patient')
INSERT [dbo].[Testimonials] ([Id], [Rating], [Title], [Text], [Image], [Name], [Surname]) VALUES (4, 4, N'Best Advices', N'Integer posuere erat a ante venenatis dapibus posuere velit aliquet. Maecenas faucibus mollis interdum. Donec ullamcorper nulla non metus auctor fringilla.', N'woman-wearing-mask-face-closeup-covid-19-green-background.jpeg', N'Rosey ', N'Almost Recovered')
